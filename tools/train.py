...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            writer.add_graph(model, input_to_model=(imgs, labels, boxes), verbose=False)
            writer.close()
            ...
            # 统计loss
            train_loss_sigma.append(train_loss.mean().cpu())
        ...
        for i, data in enumerate(valid_loader):
            ...
            # 统计loss
            valid_loss_sigma.append(valid_loss.mean().cpu())
